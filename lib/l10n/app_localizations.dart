...
abstract class AppLocalizations {
  ...
  /// No description provided for @zztTitle.
  ///
  /// In en, this message translates to:
  /// **'ZZT Flutter Simple example'**
  String get zztTitle;

  /// No description provided for @s1_1.
  ///
  /// In en, this message translates to:
  /// **'Main'**
  String get s1_1;

  /// No description provided for @s1_2.
  ///
  /// In en, this message translates to:
  /// **'Chat'**
  String get s1_2;

  /// No description provided for @s1_3.
  ///
  /// In en, this message translates to:
  /// **'Rooms'**
  String get s1_3;

  /// No description provided for @s1_4.
  ///
  /// In en, this message translates to:
  /// **'Meet'**
  String get s1_4;

  /// No description provided for @s1_5.
  ///
  /// In en, this message translates to:
  /// **'Setting'**
  String get s1_5;
