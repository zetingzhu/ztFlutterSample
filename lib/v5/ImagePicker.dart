...
class ImagePickerSample extends StatefulWidget {
  const ImagePickerSample({super.key, this.title});

  final String? title;

  @override
  State<ImagePickerSample> createState() => _ImagePickerState();
}

class _ImagePickerState extends State<ImagePickerSample> {
  ...
  Future<void> _onImageButtonPressed(
    ...
    if (context.mounted) {
      if (isVideo) {
        ...
        if (allowMultiple) {
          // Note: pickMultiVideo doesn't exist, so we'll pick a single video for now
