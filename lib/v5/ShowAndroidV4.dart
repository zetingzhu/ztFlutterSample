...
import 'entiy/CountBean.dart';

class ShowAndroidV4 extends StatefulWidget {
  const ShowAndroidV4({super.key});

  @override
  State<ShowAndroidV4> createState() => _ShowAndroidV4State();
}

class _ShowAndroidV4State extends State<ShowAndroidV4> {
  ...
  final String viewType =
      'com.example.flutter_mix_android.ui.flutterplugin.platform/ComputeLayoutPlatform';
  static const String FLUTTER_SEND_ANDROID_DATA_NOTICE =
      'flutterSendAndroidDataNotice'; // Flutter端 向 Android端 发送数据
  static const String FLUTTER_GET_ANDROID_DATA_NOTICE =
      'flutterGetAndroidDataNotice'; // Flutter端 获取 Android端 数据
  static const String ANDROID_SEND_FLUTTER_DATA_NOTICE =
      'androidSendFlutterDataNotice'; // Android端 向 Flutter端 发送数据
  static const String ANDROID_GET_FLUTTER_DATA_NOTICE =
      'androidGetFlutterDataNotice'; // Android端 获取 Flutter端 数据

  /// 初始化消息通道
  initChannel(int viewId) {
    channel = MethodChannel(
      'flutter.mix.android/compute/$viewId',
  ...
  flutterSendAndroidData() {
    ...
    channel
        .invokeMethod(FLUTTER_SEND_ANDROID_DATA_NOTICE, map)
        .then((value) {
        ...
        .catchError((e) {
          if (e is MissingPluginException) {
            debugPrint(
              '$FLUTTER_SEND_ANDROID_DATA_NOTICE --- Error：notImplemented --- 未找到Android端具体实现函数',
            );
          } else {
  ...
  flutterGetAndroidData() {
    channel
        .invokeMethod(FLUTTER_GET_ANDROID_DATA_NOTICE)
        .then((value) {
        ...
        .catchError((e) {
          if (e is MissingPluginException) {
            debugPrint(
              '$FLUTTER_GET_ANDROID_DATA_NOTICE --- Error：notImplemented --- 未找到Android端具体实现函数',
            );
          } else {
            ...
            children: [
              Expanded(
                ...
                child: AndroidView(
                  viewType: viewType,
                  // Android原生View 在Flutter引擎上注册的唯一标识，在Flutter端使用时必须一样
                  creationParams: {'flutterNum': countBean.curNum.value},
